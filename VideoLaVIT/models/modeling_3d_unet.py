...
from .modeling_unet_3d_blocks import UNetMidBlockSpatioTemporal, CrossAttnDownBlockSpatioTemporal, CrossAttnUpBlockSpatioTemporal 
try:
...
class UNetSpatioTemporalConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    Parameters:
        ...
        in_channels (`int`, *optional*, defaults to 10): Number of channels in the input sample.
    ...
    def __init__(
        ...
        for i, down_block_type in enumerate(down_block_types):
            ...
            if down_block_type == "CrossAttnDownBlockSpatioTemporal":
                ...
                assert down_block_type == "DownBlockSpatioTemporal"
        ...
        for i, up_block_type in enumerate(up_block_types):
            ...
            if up_block_type == "CrossAttnUpBlockSpatioTemporal":
                ...
                assert up_block_type == "UpBlockSpatioTemporal"
