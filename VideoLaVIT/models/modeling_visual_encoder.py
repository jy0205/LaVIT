...
def build_eva_clip(model_path, use_xformers=False):

    if xops is None or (not use_xformers):
        use_xattn = False
    else:
        use_xattn = True
        print("Use the Xformers for saving memory, please make sure your \
            device supports xformers. (V100 doesn't support now)")
